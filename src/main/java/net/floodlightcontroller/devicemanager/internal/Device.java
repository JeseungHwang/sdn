...
import net.floodlightcontroller.notification.syslog.SyslogNotificationHandler;
...
public class Device implements IDevice {
	...
	protected boolean updateAttachmentPoint() {
		...
		if (moved) {
			...
			//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
			sysNotificationHandler.sendLogMessage("updateAttachmentPoint: ap "+attachmentPoints.toString());
